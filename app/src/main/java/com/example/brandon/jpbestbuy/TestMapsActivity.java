...
public class TestMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(tokeyTower).title("Marker in tokeyTower"));
        mMap.setMyLocationEnabled(true);
        mMap.setOnCameraChangeListener(new GoogleMap.OnCameraChangeListener() {
            @Override
            public void onCameraChange(CameraPosition position) {
                LatLngBounds bounds = mMap.getProjection().getVisibleRegion().latLngBounds;
                Log.d("C", "CameraChange:" + bounds.toString());
                if (bounds.contains(tokeyTower)) {
                    Log.d("C", "CameraChange: tokeyTower in the bound!");
                }
                //fetchData(bounds);
            }
        });
